    ...
    public class TaxiFinderSQLRepository : TaxiFinderRepository
    {
        ...
        private List<Taxi> GetMock()
        {
            return new List<Taxi>() {
                new Taxi(){  Id=1, Name="Taxi 1", IsAvailable=true, Price=10, IsPremium=false},
                new Taxi(){  Id=2, Name="Taxi 2", IsAvailable=true, Price=10, IsPremium=false},
                new Taxi(){  Id=3, Name="Taxi 3", IsAvailable=false, Price=10, IsPremium=false},
                new Taxi(){  Id=4, Name="Taxi 4", IsAvailable=true, Price=12, IsPremium=true},
            };
        }
    }
}